...
cava_idf_step2 = %Step{
  ...
  processes: [
    ...
    %Vae.Meta{
      description:
        "A réception de l’accord de recevabilité, demander au CAVA un contrat d’accompagnement et un devis pour l’accompagnement nominatif et personnalisé"
    }
  ]
}
...
cava_idf_step3 = %Step{
  ...
  description:
    "Pour obtenir le financement de votre VAE par Pôle emploi et le Conseil Régional d'Ile de France",
  processes: [
    %Vae.Meta{
      title: "Faire une demande de financement de votre VAE à votre conseiller-e Pôle emploi",
      description:
        "Depuis pole-emploi.fr dans votre «espace personnel», dans la rubrique «mes échanges avec Pôle emploi» OU depuis l’application mobile dans la rubrique «contacter un conseiller»",
      attachment: %Vae.Attachment{
        type: "link",
    ...
    %Vae.Meta{
      description:
        "Fournir votre accord de recevabilité + votre contrat d’accompagnement + votre devis d’accompagnement signé à votre conseiller-e qui se chargera d'envoyer la demande au Conseil Régional"
    },
    %Vae.Meta{
      description:
        "Attendre l’accord de financement du Conseil Régional pour démarrer l’accompagnement. Vous le recevrez chez vous"
    }
  ],
  annexes: [
    %Vae.Meta{
...
cava_idf_step4 = %Step{
  ...
  processes: [
    %Vae.Meta{
      description:
        "Contacter votre CAVA pour l’informer de l’accord de financement et prendre votre 1er rdv d’accompagnement"
    }
  ]
}
...
cava_idf_step5 = %Step{
  ...
  description:
    "Pour présenter vos expériences, vos compétences, votre environnement de travail et vos outils, en lien avec le référentiel du diplôme visé",
  processes: [
    %Vae.Meta{
...
cava_idf_step6 = %Step{
  ...
  description:
    "Pour soutenir votre livret 2 et le faire évaluer devant un jury constitué d’enseignants du diplôme et de professionnels du métier",
  processes: [
    %Vae.Meta{
...
cava_idf_step7 = %Step{
  ...
  title: "Résultat",
  description:
    "Les résultats vous seront communiqués quelques semaines après l’oral. 3 situations possibles :",
  processes: [
    %Vae.Meta{
    ...
    %Vae.Meta{
      description:
        "La réussite partielle : Bravo, une partie de vos compétences est attestée et vous pouvez les compléter !"
    },
    %Vae.Meta{
      description:
        "La non obtention : Rapprochez-vous de votre conseiller-e pour convenir de propositions adaptées"
    }
  ]
}
  ...
  processes: [
    ...
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://cache.media.education.gouv.fr/file/aout2016/72/6/dava_2016_descriptif_parcours_diplomes_educ_nat_658726.pdf"
      }
    },
    %Vae.Meta{
  ...
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://cache.media.education.gouv.fr/file/2017/71/1/livret1V2017-300617_789711.pdf"
      }
    },
    %Vae.Meta{
      description: "Renvoyer ou déposer votre Livret 1"
    ...
    %Vae.Meta{
      description:
        "A réception de l’accord de recevabilité, demander au DAVA un contrat d’accompagnement et un devis pour l’accompagnement nominatif et personnalisé"
    }
  ]
}
...
dava_78_step4 = %Step{
  ...
  processes: [
    %Vae.Meta{
      description:
        "Contacter votre DAVA pour l’informer de l’accord de financement et prendre votre 1er rdv d’accompagnement"
    }
  ]
}
  ...
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://cache.media.education.gouv.fr/file/2017/71/5/dava_2016_education_nationale_livret2_2017-300617_789715.pdf"
      }
    },
    %Vae.Meta{
  ...
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://gipfcip.scola.ac-paris.fr/vae/spip.php?action=acceder_document&arg=89&cle=a7d10e6876f6c6e3c34d7d593f0a240786d3c7a5&file=doc%2Flivret_1_demande_vae_03062016.doc"
      }
    },
    %Vae.Meta{
      description: "Renvoyer ou déposer votre Livret 1"
  ...
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://gipfcip.scola.ac-paris.fr/vae/spip.php?action=acceder_document&arg=88&cle=669ddd5eb2a83ccf3fd5d0fad680faf8cd134592&file=doc%2Flivret2vae22102015.doc"
      }
    },
    %Vae.Meta{
      description: "Remettre votre Livret 2 au DAVA lorsqu’il est finalisé"
...
asp_step1 = %Step{
  ...
  description:
    "Pour être informé-e sur votre projet VAE du secteur sanitaire et social et recevoir vos documents",
  processes: [
    %Vae.Meta{
    ...
    %Vae.Meta{
      description:
        "Par courrier : ASP- UNACESS, 15 rue Léon walras - CS 70902 - 87017 Limoges cedex"
    }
  ]
}
...
asp_step3 = %Step{
  ...
  processes: [
    %Vae.Meta{
      title:
        "Si vous avez identifié un organisme accompagnateur VAE pour le DEAS, faites-vous confirmer qu’il est bien référencé par la région IDF",
      description:
        "L’organisme peut vous le confirmer sinon, vous pouvez faire cette demande à votre conseiller-e Pôle emploi depuis pole-emploi.fr dans votre «espace personnel», dans la rubrique «mes échanges avec Pôle emploi» OU depuis l’application mobile dans la rubrique «contacter un conseiller»"
    },
    %Vae.Meta{
      title: "Si vous n’avez pas identifié d’organisme accompagnateur",
      description:
        "Adresser une demande à votre conseiller-e Pôle emploi depuis pole-emploi.fr dans votre «espace personnel», dans la rubrique «mes échanges avec Pôle emploi» OU depuis l’application mobile dans la rubrique «contacter un conseiller»"
    },
    %Vae.Meta{
      title:
        "Contacter l’organisme accompagnateur retenu et lui demander un devis et un contrat d’accompagnement nominatifs et personnalisés"
    }
  ]
}
...
asp_step5 = %Step{
  ...
  processes: [
    %Vae.Meta{
      description:
        "Contacter votre organisme accompagnateur pour l’informer de l’accord de financement et prendre votre 1er rdv d’accompagnement"
    }
  ]
}
...
asp_step7 = %Step{
  ...
  title: "Passage devant le jury",
  description:
    "Pour soutenir votre livret 2 et le faire évaluer, devant un jury constitué d’enseignant du diplôme et de professionnels du métier",
  processes: [
    %Vae.Meta{
...
asp_step8 = %Step{
  ...
  title: "Résultat",
  description:
    "Les résultats vous seront communiqués, par courrier,  quelques semaines après l’oral. 3 situations possibles",
  processes: [
    %Vae.Meta{
      description: "La réussite : Bravo !"
    },
    ...
    %Vae.Meta{
      description:
        "Non obtention : Rapprochez-vous de votre conseiller-e pour convenir de propositions adaptées et rebondir"
    }
  ]
}
...
afpa_75_93_step1 = %Step{
  ...
  title: "Réunion d’information",
  description:
    "Pour être conseillé-e et informé-e sur votre projet VAE et vous faire remettre votre dossier de demande de VAE",
  processes: [
    %Vae.Meta{
      description:
        "Adresser un mail au référent VAE AFPA de votre département pour être inscrit-e à une réunion VAE",
      attachment: %Vae.Attachment{
        type: "mail",
    ...
    %Vae.Meta{
      description:
        "Bénéficier d'un entretien individuel en fin de réunion pour identifier ou confirmer votre projet"
    },
    %Vae.Meta{
      description:
        "Vous faire remettre sur place, le dossier de demande de VAE et coordonnées de la DIRECCTE dont vous dépendez"
    }
  ]
}
...
afpa_92_step1 = %Step{
  ...
  processes: [
    ...
    %Vae.Meta{
      description:
        "Vous faire remettre sur place, le dossier de demande de VAE et coordonnées de la DIRECCTE"
    }
  ]
}
  ...
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://travail-emploi.gouv.fr/demarches-et-fiches-pratiques/formulaires-et-teledeclarations/jeunes-actifs-et-actifs-en-formation/article/demande-de-validation-des-acquis-de-l-experience-vae"
      }
    },
    %Vae.Meta{
    ...
    %Vae.Meta{
      description:
        "Attendre la réponse de recevabilité et l’envoi du dossier professionnel (livret 2)"
    },
    %Vae.Meta{
      description:
        "A réception de l’accord de recevabilité, demander à l’AFPA un contrat d’accompagnement et un devis pour l’accompagnement nominatif et personnalisé."
    }
  ]
}
...
afpa_75_93_step4 = %Step{
  ...
  title: "Accompagnement (facultatif mais recommandé)",
  description:
    "Pour être aidé-e dans la rédaction du dossier professionnel, visiter le plateau technique du centre d’examen et vous préparer à la mise en situation (s’il y a lieu)",
  processes: [
    %Vae.Meta{
      description:
        "Contacter votre centre AFPA pour l’informer de l’accord de financement et prendre votre 1er rdv d’accompagnement"
    }
  ]
}
...
afpa_75_93_step5 = %Step{
  ...
  description:
    "Pour présenter vos expériences, vos compétences, votre environnement de travail et vos outils, en lien avec le référentiel du titre professionnel visé",
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "https://www.google.fr/url?sa=t&rct=j&q=&esrc=s&source=web&cd=2&cad=rja&uact=8&ved=0ahUKEwiwu_OPuYHVAhWE1xoKHSFFAVwQFggtMAE&url=https%3A%2F%2Fdfpc.gouv.nc%2Fsites%2Fdefault%2Ffiles%2Ftelechargement%2Fdossier_professionnel_vf.docx&usg=AFQjCNFosbFmj_JabXWsVyjnZU2CMwiwEQ"
      }
    },
    %Vae.Meta{
...
afpa_75_93_step6 = %Step{
  ...
  index: 6,
  title:
    "Passage devant le jury et mise en situation (pour la majorité des titres professionnels)",
  description:
    "Pour soutenir votre dossier professionnel  et faire évaluer vos compétences, devant un jury constitué de formateurs du titre professionnel",
  processes: [
    %Vae.Meta{
      description:
        "Préparation de cet oral avec votre conseiller en accompagnement VAE et par un entretien préalable avec un formateur et par la visite du plateau technique de mise en situation (compris dans l’accompagnement)"
    },
    %Vae.Meta{
    ...
    %Vae.Meta{
      ...
      description:
        "Vous serez invité-e à effectuer des tâches dans les mêmes conditions que le contexte professionnel du titre professionnel visé (La durée est variable selon le titre professionnel visé)"
    },
    %Vae.Meta{
...
afpa_75_93_step7 = %Step{
  ...
  title: "Résultat",
  description:
    "Les résultats vous seront communiqués quelques semaines après l’oral, par courrier, par la DIRECCTE. 3 situations possibles :",
  processes: [
    %Vae.Meta{
      description: "La réussite : Bravo !"
    },
    ...
    %Vae.Meta{
      description:
        "La non-obtention : Rapprochez-vous de votre conseiller pour convenir de propositions adaptées"
    }
  ]
}
  ...
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://ile-de-france.drjscs.gouv.fr/sites/ile-de-france.drjscs.gouv.fr/IMG/doc/LIVRET_VAE_PARTIE_1-2.doc"
      }
    },
    %Vae.Meta{
      description:
        "Renvoyer par courrier le livret 1 et vos justificatifs en 2 exemplaires (dont un original) à la DRJSCS"
    },
    %Vae.Meta{
      description:
        "Attendre l’avis de recevabilité pour solliciter un accompagnement de votre parcours VAE. Avec votre avis de recevabilité, vous recevrez votre date et votre lieu de jury"
    }
  ]
}
...
drjscs_step2 = %Step{
  ...
  index: 2,
  title:
    "Identifier votre organisme d’accompagnement référencé par la Région IDF (afin que le coût puisse être pris en charge)",
  description: "Pour solliciter un accompagnement de votre VAE",
  processes: [
    %Vae.Meta{
...
"
    ...
    %Vae.Meta{
      ...
      description:
        "Adressez une demande à votre conseiller Pôle emploi depuis votre « espace personnel », dans la rubrique « mes échanges avec Pôle emploi » OU  depuis l’application mobile dans la rubrique « contacter un conseiller ». Il pourra vous proposer les coordonnées d’un organisme accompagnateur référencé par la Région IDF pour la VAE de votre diplôme"
    },
    %Vae.Meta{
      description:
        "Contacter l’organisme accompagnateur retenu et demandez-lui un devis et un contrat d’accompagnement nominatifs et personnalisés."
    }
  ]
}
...
drjscs_step3 = %Step{
  ...
  processes: [
    ...
    %Vae.Meta{
      description:
        "Fournir votre avis de recevabilité + votre contrat d’accompagnement + votre devis d’accompagnement signé à votre conseiller"
    },
    %Vae.Meta{
  ...
  processes: [
    %Vae.Meta{
      ...
      attachment: %Vae.Attachment{
        type: "document",
        target:
          "http://ile-de-france.drjscs.gouv.fr/sites/ile-de-france.drjscs.gouv.fr/IMG/doc/LIVRET_VAE_PARTIE_2-2.doc"
      }
    }
  ]
}
...
drjscs_step6 = %Step{
  ...
  description:
    "Pour remplir aux obligations administratives préalables à la soutenance devant le jury",
  processes: [
    %Vae.Meta{
      title:
        "Renvoyer au service organisateur (mentionné dans votre avis de recevabilité) les deux parties de votre dossier VAE en 4 exemplaires (dont 1 original)"
    },
    %Vae.Meta{
    ...
    %Vae.Meta{
      description:
        "Un courrier (facultatif) pour demander un entretien avec le jury si vous le souhaitez"
    }
  ]
}
...
drjscs_step8 = %Step{
  ...
  title: "Résulltat",
  description:
    "Les résultats vous seront communiqués, par courrier, quelques semaines après l’oral",
  processes: [
    %Vae.Meta{
      description: "La réussite : Bravo !"
    },
    ...
    %Vae.Meta{
      description:
        "Non obtention : rapprochez-vous de votre conseiller pour convenir de propositions adaptées et rebondir"
    }
  ]
}
...
insert_delegates.([dava78, dava91, dava92_north, dava92_south], dava_78_steps, educ_nat)
...
employment_ministry_map = %{
  name: "Ministère du travail de l'emploi de la formation professionnelle et du dialogue social"
}
...
employment_ministry =
  ...
  |> Repo.insert!(
    on_conflict: [set: [name: employment_ministry_map.name]],
...
insert_delegates.([afpa_77_1, afpa_77_2, afpa_77_3], afpa_77_steps, employment_ministry)
...
insert_delegates.([afpa_78_1, afpa_78_2], afpa_78_steps, employment_ministry)
...
insert_delegates.(
  [afpa_92_1, afpa_92_2, afpa_92_3, afpa_92_4],
  afpa_92_steps,
  employment_ministry
)
...
insert_delegates.([afpa_95_1, afpa_95_2], afpa_95_steps, employment_ministry)
