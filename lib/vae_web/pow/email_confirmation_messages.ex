defmodule VaeWeb.Pow.Messages.PowEmailConfirmation.Phoenix.Messages do
  @moduledoc """
  ...
  """
  def confirmation_email_has_been_resent(_conn),
    do: "Un email de confirmation vous a été renvoyé."
  ...
  def email_confirmation_required_for_update(_conn),
    do: "Vous devez d'abord confirmer votre adresse email."
end
