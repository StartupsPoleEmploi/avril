defmodule VaeWeb.Pow.Messages.PowResetPassword.Phoenix.Messages do
  @moduledoc """
  ...
  def maybe_email_has_been_sent(_conn),
    do:
      "Nous vous avons envoyé un lien de réinitialisation par email. Merci de vérifier votre boîte de réception."
