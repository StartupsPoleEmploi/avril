defmodule Vae.Booklet.Education do
  ...
  def degree_label(%Education{degree: degree}) do
    case degree do
      ...
      6 -> "DEUG, DEUST, BTS ou autre certification de niveau III (niveau. CEC : 5)"
      7 -> "Licence, licence professionnelle, Maîtrise, BUT ou autre certification de niveau II (niveau CEC : 6)"
