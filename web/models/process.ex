defmodule Vae.Process do
  ...
  def changeset(process, params \\ %{}) do
    process
    |> cast(params, ~w(name booklet_1 booklet_2 step_1 step_2 step_3 step_4 step_5 step_6 step_7 step_8))
  ...
  def add_delegates(changeset, %{delegates: delegates}) do
    ...
    |> put_assoc(
      :delegates,
      delegates |> ensure_not_nil |> transform_destroy |> retrieve_delegates |> Enum.uniq_by(&(&1.id))
    )
  end
