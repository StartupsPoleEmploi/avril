defmodule Vae.SearchController do
  ...
  def search(conn, params) do
    conn
    |> put_flash(:warning, "Veuillez sélectionner une proposition dans les suggestions de recherche")
  ...
  #     _error ->
  #       conn
  #       |> put_flash(:danger, "La recherche n'a pas abouti. Merci de réessayer avec une autre recherche.")
  #       |> redirect(to: Routes.root_path(conn, :index))
  #   end
  # end
